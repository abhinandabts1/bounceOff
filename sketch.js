...
function setup() {
  ...
  gameObject3 = createSprite(100,650,50,50);
  gameObject3.shapeColor = "green";
  gameObject4 = createSprite(1100,650,50,50);
...
if(isTouching(movingRect,gameObject1) || isTouching(movingRect,fixedRect)){
  textSize(30);
  text("Yeiiii Toched",100,200);
}
